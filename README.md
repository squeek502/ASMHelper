...
To use the Javascript version, put [src/main/javascript/asmhelper.js](asmhelper.js) next to your core mod's javascript file and load it in your `initializeCoreMods` function like so:
